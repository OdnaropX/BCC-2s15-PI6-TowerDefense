    ...
    typedef enum _choose_room_options{CR_ENTER_ROOM, CR_REFRESH, CR_STOP, CR_RETURN} choose_room_options;
    typedef enum _multiplayer_room_options{MR_READY, MR_EXIT};
